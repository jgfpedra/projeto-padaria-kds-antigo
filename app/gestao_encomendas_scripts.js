...
async function pesquisarEncomendas() {
    ...
    try {
        ...
        pedidos.forEach(pedido => {
            ...
            } else if (new Date(pedido.data_entrega) < new Date() && pedido.id_status === 1) {
